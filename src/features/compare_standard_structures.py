...
def compare_feature_groups(all_results, output_dir=None):
    ...
    plt.ylabel('O-Ce Angle with z-axis (degrees)')
    plt.title('Comparison of O-Ce Angle with z-axis by Feature Group')
    if output_dir:
    ...
    plt.xlabel('Feature Group')
    plt.ylabel('O-Ce Angle with xy-plane (degrees)')
    plt.title('Comparison of O-Ce Angle with xy-plane by Feature Group')
    if output_dir:
    ...
    plt.xlabel('Feature Group')
    plt.ylabel('O-Ce Distance (Å)')
    plt.title('Comparison of O-Ce Distance by Feature Group')
    if output_dir:
    ...
    if not dihedral_df.empty and 'feature_group' in dihedral_df.columns:
        ...
        plt.xlabel('Feature Group')
        plt.ylabel('O-Ce-O Dihedral Angle (degrees)')
        plt.title('Comparison of O-Ce-O Dihedral Angle by Feature Group')
        if output_dir:
    ...
    plt.xlabel('Feature Group')
    plt.ylabel('O-Ce Angle with z-axis (degrees)')
    plt.title('Comparison of O-Ce Angle with z-axis by Feature Group (Violin Plot)')
    if output_dir:
    ...
    plt.xlabel('O-Ce Distance (Å)')
    plt.ylabel('O-Ce Angle with z-axis (degrees)')
    plt.title('Relationship between O-Ce Distance and Angle (by Feature Group)')
    ...
    if 'dopant' in bond_df.columns:
        ...
        plt.title('Average O-Ce Angle with z-axis by Dopant and Feature Group')
        plt.tight_layout()
        if output_dir:
...
def main():
    ...
    # 创建输出目录
    output_dir = '/Users/wukai/Desktop/project/wjob/results/figures/standard_comparison'
    os.makedirs(output_dir, exist_ok=True)
